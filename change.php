...
<body id="body-pd">
    ...
    <nav class="nav">
            <div> <a href="#" class="nav_logo"> <i class='bx bx-layer nav_logo-icon'></i> <span class="nav_logo-name">Student Portal</span> </a>
                ...
                <a href="admin_view.php" class="nav_link active"> <i class='bx bx-user nav_icon'></i> <span class="nav_name">View Grade</span> </a> 
                <a href="edit_grades.php" class="nav_link"> <i class='bx bx-edit' ></i> <span class="nav_name">Edit Grades</span> </a> 
                </div>
